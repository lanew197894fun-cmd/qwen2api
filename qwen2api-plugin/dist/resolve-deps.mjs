...
const log = {
    ...
    warn: (...a) => console.log("[resolve-deps] ⚠️", ...a),
    error: (...a) => console.log("[resolve-deps] ❌", ...a),
};
// ─── 工具函數 ───
/** 安全解析符號連結 */
        ...
        if (exists(pkgJsonPath)) {
            ...
            if (exports) {
                ...
                if (typeof exports === "object") {
                    ...
                    if (importEntry) {
                        const exportPath = path.join(basePath, typeof importEntry === "string"
                            ? importEntry
                            : importEntry.default);
                        return await import(normalizePath(exportPath));
                    }
...
// ─── 匯出 ───
export { resolvePackage, resolvePackages, importResolved, checkAndRepair, safeRealpath, isDir, exists, IS_WIN, IS_MAC, IS_LINUX, PLUGIN_DIR, PROJECT_ROOT, SHARED_DEPS_DIR, PLUGIN_NODE_MODULES, };
//# sourceMappingURL=resolve-deps.mjs.map